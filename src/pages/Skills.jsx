              ...
              <div className="experience-timeline">
                <div className="timeline-item">
                  ...
                  <div className="timeline-content">
                    <span className="period">2025 – Present</span>
                    <h4 className="role">CTO – Malindi Salt Works Ltd, Mombasa Maize Millers Group</h4>
                    <p className="description">
                      Currently leading networking and IT support for Malindi Salt Works, managing infrastructure, security, and digital operations across the group.
                    </p>
                  </div>
                </div>
